...
COMMANDS = {
    ...
    "Stocks": {
        ...
        "stockinfo <ticker>": "Gets stock info for custom stocks.",
        "chart <ticker>": "Get price & volume charts for custom stocks.",
...
ACAS_UPDATE_DELAY = 1
MARKET_START = 540 # 9:00 AM (start of pre-market)
MARKET_END = 1080 # 6:00 PM (end of after-hours)
MARKET_HOURS_EXISTS = True
MARKET_HOURS_CLOSED = [5, 6]
